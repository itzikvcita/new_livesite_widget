...
(function (liveSite, window) {
  ...
  var $             = liveSite.jQuery,
      ...
      // Modern chat message bubble templates
      CHAT_MESSAGE_BOT_TEMPLATE = '<div class="ls-chat-message ls-chat-message-bot">' +
                                   '<div class="ls-chat-avatar">' +
                                     '<% if (!_.isEmpty(data.avatarUrl)) { %>' +
                                       '<img src="<%- data.avatarUrl %>" alt="Bot" />' +
                                     '<% } else { %>' +
                                       '<div class="ls-chat-avatar-placeholder"></div>' +
                                     '<% } %>' +
                                   '</div>' +
                                   '<div class="ls-chat-bubble ls-chat-bubble-bot">' +
                                     '<div class="ls-chat-message-text"><%- message %></div>' +
                                     '<div class="ls-chat-message-time"><%- time %></div>' +
                                   '</div>' +
                                 '</div>',

      CHAT_MESSAGE_USER_TEMPLATE = '<div class="ls-chat-message ls-chat-message-user">' +
      ...
      TYPING_INDICATOR_TEMPLATE = '<div class="ls-typing-indicator">' +
                                  '<div class="ls-chat-avatar">' +
                                    '<% if (!_.isEmpty(data.avatarUrl)) { %>' +
                                      '<img src="<%- data.avatarUrl %>" alt="Bot" />' +
                                    '<% } else { %>' +
                                    ...
                                    '<% } %>' +
                                  '</div>' +
                                  '<div class="ls-chat-bubble ls-chat-bubble-bot ls-typing-bubble">' +
                                    '<div class="ls-typing-dots">' +
                                      '<span class="ls-typing-dot"></span>' +
                                      '<span class="ls-typing-dot"></span>' +
                                      '<span class="ls-typing-dot"></span>' +
                                    '</div>' +
                                  '</div>' +
      ...
      QUICK_REPLY_CHIPS_TEMPLATE = '<div class="ls-quick-replies">' +
                                    '<% _.forEach(chips, function(chip) { %>' +
                                      '<button class="ls-quick-reply-chip" data-action="<%- chip.action %>" data-url="<%- chip.url || \'#\' %>" data-options="<%- chip.options || \'\' %>">' +
                                        '<%- chip.text %>' +
                                      '</button>' +
                                    '<% }); %>' +
                                  '</div>',
