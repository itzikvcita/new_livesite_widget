...
module.exports = (env, argv) => {
  ...
  return {
    entry: './src-modern/livesite.js',
    output: {
      path: path.resolve(__dirname, 'dist-modern'),
      filename: isProduction ? 'livesite.modern.min.js' : 'livesite.modern.js',
    ...
    plugins: [
      new CopyWebpackPlugin({
        patterns: [
          {
            from: path.resolve(__dirname, 'src-modern/scss/icomoon/fonts'),
            to: path.resolve(__dirname, 'dist-modern/fonts'),
    ...
    resolve: {
      extensions: ['.js'],
      modules: [path.resolve(__dirname, 'src-modern'), 'node_modules'],
    },
