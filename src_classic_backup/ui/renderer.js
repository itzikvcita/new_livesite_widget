...
(function (liveSite, window) {
  ...
  var $             = liveSite.jQuery,
      ...
      ACTIVE_ENGAGE_TEMPLATE = '<div id="livesite_active_engage" class="ls-font-family-T ls-font-size-T ls-zoom ls-overlay-T<% if (data.themeVariant) { %> ls-theme-<%= data.themeVariant %><% } %>" dir="<%= data.rtl ? "rtl" : "ltr" %>">' +
      ...
      ENGAGE_BUTTON_TEMPLATE =  '<div id="livesite_engage_button" class="ls-font-family-T ls-font-size-T ls-zoom<% if (data.themeVariant) { %> ls-theme-<%= data.themeVariant %><% } %>" dir="<%= data.rtl ? "rtl" : "ltr" %>">'+
      ...
      ACTION_BUTTONS_TEMPLATE = '<div id="livesite_action_buttons" class="ls-font-family-T ls-font-size-T ls-zoom ls-overlay-T<% if (data.themeVariant) { %> ls-theme-<%= data.themeVariant %><% } %>" dir="<%= data.rtl ? "rtl" : "ltr" %>">' +
