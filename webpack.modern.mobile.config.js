...
module.exports = (env, argv) => {
  ...
  return {
    entry: './src-modern/scss/livesite_mobile.scss',
    output: {
      path: path.resolve(__dirname, 'dist-modern'),
      filename: 'livesite.modern.mobile.js', // Dummy JS file, we only need CSS
    ...
    plugins: [
      new MiniCssExtractPlugin({
        filename: isProduction ? 'livesite.modern.mobile.min.css' : 'livesite.modern.mobile.css',
      }),
    ],
    optimization: {
